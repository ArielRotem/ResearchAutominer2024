...
def main():
    ...
    data = flag_antibiotic_within_timeframe_idx(
        data, 'onset of fever 38 after delivery-date of measurement', 'antibiotics-medication_1', 'antibiotics-date administered _1', 103, 3, 'birth-date of first documentation - birth occurence', 'Penicillin/Clindamycin_given_between_delivery_and_fever', antibiotics_to_include=['PENICILLIN G SODIUM', 'CLINDAMYCIN HCL', 'CLINDAMYCIN PHOSPHATE']
    )
    data = flag_antibiotic_within_timeframe_idx(
