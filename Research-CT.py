...
def main():
 ...
 #    data = extract_and_filter_raw_map(
   ...
   # data = create_indicator_column_by_keyword(data, 'other_culture_samples_taken', 'מורסה', 'abscess_culture_was_taken_yes_no')
    ...
    data = reorder_columns(data, ["Patient_Index", "patient id", "age when documented", "bmi-numeric result", "maternal_pregestational_diabetes_yes_or_no", "maternal_pregestational_hypertension_yes_or_no", "gravidity - pregnancy number", "parity - birth number", "nulliparous_yesno", "gestational_week", "gestational_day", "preterm_labor_yes_or_no", "Multifetal pregnancy_yes_or_no", "hospitalization before delivery (hrp) - length of stay (days)", "hospitalization before delivery_other - length of stay (days)", "HRP_hospitalization_prepartum_yes_or_no", "other_hospitalization_prepartum_yes_or_no", "Pre-labor_HRP_over_3d_yes_or_no", "Pre-labor_other_over_3d_yes_or_no", "maternal_gestational_diabetes_yes_or_no", "maternal_gestational_hypertension_yes_or_no", "maternal_pph_yes_or_no", "maternal vte_after_delivery_yes_or_no", "maternal vte_before_delivery_yes_or_no", "maternal_infection_post_partum_yes_or_no", "GBS_vaginal_Result", "PPROM_yes_or_no", "pprom diagnosis-days from reference", "augmentation meds-date administered-hours from reference", "balloon/propes-date of measurement-days from reference", "misoprostol_yes/no", "pitocin_yes/no", "propes_yes/no", "balloon_yes/no", "induction_yes/no", "amniofusion-non-numeric result", "rom description-amniotic fluid color", "rom description-date of membranes rupture-hours from reference", "duration_of_rom_over_18h", "membranes rupture type", "second stage length", "duration_of_2nd_stage_over_4h", "packed_cells_received_yes_or_no", "packed_cells_before_count", "packed_cells_after_count", "multiple packed cells (4 and above) yes/no", "uterotonics_received", "uterotonics yes/no", "delivery_room_stay_hours", "neuraxial analgesia-anesthesia type", "NVD_yes_or_no", "vacuume_yes_or_no", "forceps_yes_or_no", "CS_yes_or_no", "Elective_CS_yes/no", "Urgent_CS_yes/no", "sufficient_disinfection_yes/no", "full_dilation_at_surgery_yes_or_no", "surgery_time_category", "surgery_duration_hours", "surgery duration", "hemostasis_yes/no", "Cesarean_Hysterectomy yes/no", "hospitalization after delivery - length of stay (days)", "hospitalization after delivery_other- length of stay (days)", "other_hospitalization_postpartum_yes_or_no", "length_of_stay_after_CTI", "length_of_stay_after_first_CT", "transfer to icu-department", "transfer to icu-department length of stay", "readmission length readmission-hospital admission date-days from reference", "readmission_OBGYN_yes/no", "readmission_Other_yes/no", "imaging_ct/cti (first 10)-exam start time-days from reference_1", "imaging_ct/cti (first 10)-exam start time-date_1", "imaging_ct/cti (first 10)-interpretation_1", "Imaging_Infectious_Reason_1", "Infectious_Reason_Snippet_1", "Imaging_Collection_Sentences_Extracted_1", "Imaging_Appendicitis_Yes_No_1", "Imaging_Appendicitis_Yes_No_Reason_1", "Imaging_ureter_Yes_No_1", "Imaging_ureter_Yes_No_Reason_1", "Imaging_Intestine_Yes_No_1", "Imaging_Intestine_Yes_No_Reason_1", "Imaging_OVT_Yes_No_1", "Imaging_OVT_Yes_No_Reason_1", "closest_PLT_1", "closest_CRP_1", "closest_WBC_1", "closest_fever_1", "imaging_ct/cti (first 10)-exam start time-days from reference_2", "imaging_ct/cti (first 10)-exam start time-date_2", "imaging_ct/cti (first 10)-interpretation_2", "Imaging_Infectious_Reason_2", "Infectious_Reason_Snippet_2", "Imaging_Collection_Sentences_Extracted_2", "Imaging_Appendicitis_Yes_No_2", "Imaging_Appendicitis_Yes_No_Reason_2", "Imaging_ureter_Yes_No_2", "Imaging_ureter_Yes_No_Reason_2", "Imaging_Intestine_Yes_No_2", "Imaging_Intestine_Yes_No_Reason_2", "Imaging_OVT_Yes_No_2", "Imaging_OVT_Yes_No_Reason_2", "closest_PLT_2", "closest_CRP_2", "closest_WBC_2", "closest_fever_2", "imaging_ct/cti (first 10)-exam start time-days from reference_3", "imaging_ct/cti (first 10)-exam start time-date_3", "imaging_ct/cti (first 10)-interpretation_3", "Imaging_Infectious_Reason_3", "Infectious_Reason_Snippet_3", "Imaging_Collection_Sentences_Extracted_3", "Imaging_Appendicitis_Yes_No_3", "Imaging_Appendicitis_Yes_No_Reason_3", "Imaging_ureter_Yes_No_3", "Imaging_ureter_Yes_No_Reason_3", "Imaging_Intestine_Yes_No_3", "Imaging_Intestine_Yes_No_Reason_3", "Imaging_OVT_Yes_No_3", "Imaging_OVT_Yes_No_Reason_3", "closest_PLT_3", "closest_CRP_3", "closest_WBC_3", "closest_fever_3", "imaging_ct/cti (first 10)-exam start time-days from reference_4", "imaging_ct/cti (first 10)-exam start time-date_4", "imaging_ct/cti (first 10)-interpretation_4", "Imaging_Infectious_Reason_4", "Infectious_Reason_Snippet_4", "Imaging_Collection_Sentences_Extracted_4", "Imaging_Appendicitis_Yes_No_4", "Imaging_Appendicitis_Yes_No_Reason_4", "Imaging_ureter_Yes_No_4", "Imaging_ureter_Yes_No_Reason_4", "Imaging_Intestine_Yes_No_4", "Imaging_Intestine_Yes_No_Reason_4", "Imaging_OVT_Yes_No_4", "Imaging_OVT_Yes_No_Reason_4", "closest_PLT_4", "closest_CRP_4", "closest_WBC_4", "closest_fever_4", "imaging_ct/cti (first 10)-exam start time-days from reference_5", "imaging_ct/cti (first 10)-exam start time-date_5", "imaging_ct/cti (first 10)-interpretation_5", "Imaging_Infectious_Reason_5", "Infectious_Reason_Snippet_5", "Imaging_Collection_Sentences_Extracted_5", "Imaging_Appendicitis_Yes_No_5", "Imaging_Appendicitis_Yes_No_Reason_5", "Imaging_ureter_Yes_No_5", "Imaging_ureter_Yes_No_Reason_5", "Imaging_Intestine_Yes_No_5", "Imaging_Intestine_Yes_No_Reason_5", "Imaging_OVT_Yes_No_5", "Imaging_OVT_Yes_No_Reason_5", "closest_PLT_5", "closest_CRP_5", "closest_WBC_5", "closest_fever_5", "imaging_ct/cti (first 10)-exam start time-days from reference_6", "imaging_ct/cti (first 10)-exam start time-date_6", "imaging_ct/cti (first 10)-interpretation_6", "Imaging_Infectious_Reason_6", "Infectious_Reason_Snippet_6", "Imaging_Collection_Sentences_Extracted_6", "Imaging_Appendicitis_Yes_No_6", "Imaging_Appendicitis_Yes_No_Reason_6", "Imaging_ureter_Yes_No_6", "Imaging_ureter_Yes_No_Reason_6", "Imaging_Intestine_Yes_No_6", "Imaging_Intestine_Yes_No_Reason_6", "Imaging_OVT_Yes_No_6", "Imaging_OVT_Yes_No_Reason_6", "closest_PLT_6", "closest_CRP_6", "closest_WBC_6", "closest_fever_6", "imaging_number-count", "fever_max 38-43 before delivery-date of measurement-hours from reference", "Intrapartum_fever_yes_or_no", "Postpartum_fever_yes_or_no", "fever_max 38-43 before delivery-numeric result", "onset of fever 38 until delivery-date of measurement-hours from reference", "onset of fever 38 until delivery-numeric result", "fever_max 38-43 after delivery-date of measurement-hours from reference", "fever_max 38-43 after delivery-numeric result", "fever_sequences", "Fever_at_1st_CT_yes_or_no", "crp at 1st imaging 24h-numeric result", "plt at 1st imaging 24h-numeric result", "wbc at 1st imaging 24h-numeric result", "crp max-numeric result", "crp max-collection date-days from reference", "plt max-collection date-days from reference", "plt max-numeric result", "wbc max-collection date-days from reference", "wbc max-numeric result", "Imaging_Guided_Drainage yes/no", "first_drainage_days_from_ref", "postpartum_hysterectomy yes/no", "laparotomy yes/no", "laparoscopy yes/no", "surgical_drainage_yes/no", "GI or GU surgery yes/no", "soft tissue surgery yes/no", "postpartum_surgery_yes_or_no", "surgical complications-date of procedure-days from reference", "surgical_complication_yes_or_no", "blood_culture_taken", "blood_culture_organisms", "blood_culture_organisms_category", "Blood_culture_Type_of_growth", "blood_organisms_Contaminants_yes_or_no", "blood_organisms_Non_hemolytic_Strep_yes_or_no", "blood_organisms_Enterobacterales_yes_or_no", "blood_organisms_GBS_yes_or_no", "blood_organisms_Anaerobes_yes_or_no", "blood_organisms_Other_Gram_Negatives_yes_or_no", "blood_organisms_Vaginal_Flora_yes_or_no", "blood_organisms_Staph_Aureus_yes_or_no", "blood_organisms_Listeria_yes_or_no", "blood_organisms_Other_yes_or_no", "abscess_culture_taken", "abscess_culture_samples_taken", "abscess_culture_organisms_detected", "abscess_culture_organisms_category", "abscess_culture_Type_of_growth", "abscess_organisms_Contaminants_yes_or_no", "abscess_organisms_Non_hemolytic_Strep_yes_or_no", "abscess_organisms_Enterobacterales_yes_or_no", "abscess_organisms_GBS_yes_or_no", "abscess_organisms_Anaerobes_yes_or_no", "abscess_organisms_Other_Gram_Negatives_yes_or_no", "abscess_organisms_Vaginal_Flora_yes_or_no", "abscess_organisms_Staph_Aureus_yes_or_no", "abscess_organisms_Listeria_yes_or_no", "abscess_organisms_Other_yes_or_no", "Antibiotics_given_Ampicillin", "Antibiotics_given_Augmentin", "Antibiotics_given_Carbapenem", "Antibiotics_given_Ceftriaxone", "Antibiotics_given_Clindamycin", "Antibiotics_given_Gentamycin", "Antibiotics_given_Metronidazole", "Antibiotics_given_Penicillin", "Antibiotics_given_Tazocin", "Antibiotics_given_Other", "concat_antibiotics_given", "has_2plus_abx", "has_3plus_abx", "antibiotic_change_due_to_blood_growth", "antibiotic_change_due_to_blood_growth_debug", "antibiotic_change_due_to_other_growth", "antibiotic_change_due_to_other_growth_debug"])
